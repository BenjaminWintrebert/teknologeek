...
<div id="page" class="hfeed site">
	...
	<?php } ?>
				...
				<?php wp_nav_menu( array( 'container_id' => 'submenu','container_class' => '', 'theme_location' => 'primary','menu_id'=>'fabthemes' ,'menu_class'=>'sfmenu','fallback_cb'=> 'fallbackmenu' ) ); ?>
				</div>
			...
			<div class="intro outwrap">
				<?php echo ft_of_get_option('fabthemes_intro_text'); ?>
			</div>
